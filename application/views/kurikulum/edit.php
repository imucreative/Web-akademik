<div class="col-sm-12">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <i class="fa fa-external-link-square"></i>Form Edit Kurikulum
        ...
        <div class="panel-body">
            ...
            ?>
				<tr>
					...
					<td>
						<div class="col-sm-12">
							<input type="text" value="<?php echo $kurikulum['nama_kurikulum'];?>" name="nama_kurikulum" placeholder="* Nama Kurikulum" id="form-field-1" class="form-control limited" maxlength='30' required />
						</div>
					</td>
				</tr>
				<tr>
					...
					<td>
						<div class="col-sm-12">
							<?php echo form_dropdown('is_aktif',array('N'=>'TIDAK AKTIF','Y'=>'AKTIF'),$kurikulum['is_aktif'],"class='form-control search-select' id='form-field-2' required")?>
						</div>
					</td>
				</tr>
				<tr>
