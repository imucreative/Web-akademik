<div class="col-sm-12">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <i class="fa fa-external-link-square"></i>Form Edit Tahun Akademik
        ...
        <div class="panel-body">
            ...
            ?>
				...
				<tr>
					...
					<td>
						<div class="col-sm-12">
							<input type="text" value="<?php echo $tahun_akademik['tahun_akademik'];?>" name="tahun_akademik" placeholder="* Tahun Akademik" id="form-field-1" class="form-control" maxlength='9' required readonly />
						</div>
					</td>
				</tr>
				<tr>
					...
					<td>
						<div class="col-sm-12">
							<?php echo form_dropdown('is_aktif',array('N'=>'TIDAK AKTIF','Y'=>'AKTIF'),$tahun_akademik['is_aktif'],"class='form-control search-select' id='form-field-2' required")?>
						</div>
					</td>
				</tr>
				<tr>
					<td align='right'>
						<label class="col-sm-12 control-label"></label></td>
					<td>
						<div class="col-sm-12">
