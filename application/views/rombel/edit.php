<div class="col-sm-12">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <i class="fa fa-external-link-square"></i>Form Edit Rombongan Belajar
        ...
        <div class="panel-body">
            ...
            ?>
				...
				<tr>
					...
					<td>
						<div class="col-sm-12">
							<input type="text" value="<?php echo $rombel['nama_rombel']?>" name="nama_rombel" placeholder="* Nama Rombongan Belajar" id="form-field-1" class="form-control limited" maxlength='10' required />
						</div>
					</td>
				</tr>
				<tr>
