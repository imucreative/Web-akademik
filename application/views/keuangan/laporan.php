...
<div class="col-md-5">
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			<?php echo form_open('keuangan/data_by_rombel_excel'); ?>
				<table class="table">
					<tr>
						<td width="30%" align="right">JURUSAN :</td>
					...
					<tr>
						<td colspan="2" align="right" ><button type="submit" class="btn btn-danger btn-sm">
							<i class="fa fa-file-excel-o" aria-hidden="true"></i> Export Data</button>
						</td>
					</tr>
				</table>
            </form>
...
<script type="text/javascript">
    function loadRombel(){
        ...
        $.ajax({
            type:'GET',
            url :'<?php echo base_url(); ?>keuangan/show_combobox_rombel_by_jurusan',
    ...
    function loadSiswa(rombel){
        ...
        $.ajax({
            type:'GET',
            url :'<?php echo base_url(); ?>keuangan/load_data_siswa_by_rombel',
