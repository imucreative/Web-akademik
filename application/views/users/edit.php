<div class="col-sm-12">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <i class="fa fa-external-link-square"></i>Form Edit User
        ...
        <div class="panel-body">
			<table class="table">
            <?php
				echo form_open_multipart('users/edit', 'role="form" class="form-horizontal form"');
            ...
            ?>
				<tr>
					...
					<td>
						<div class="col-sm-12">
							<input type="text" name="nama_lengkap" value="<?php echo $user['nama_lengkap'];?>" placeholder="* Nama Lengkap" id="form-field-1" class="form-control" maxlength='100' required/>
						</div>
					</td>
				</tr>
				<tr>
					...
					<td>
						<div class="col-sm-12">
							<input type="text" name="username" value="<?php echo $user['username'];?>" placeholder="* Username" id="form-field-2" class="form-control" maxlength='20' required />
						</div>
					</td>
				</tr>
				<tr>
					...
					<td>
						<div class="col-sm-10">
							<input type="password" value="" name="password" placeholder="* Password" id="form-field-3" class="form-control password limited" maxlength="70" required />
						</div>
				...
				<tr>
					...
					<td>
						<div class="col-sm-10">
							<?php echo cmb_dinamis('id_level_user', 'tbl_level_user', 'nama_level', 'id_level_user', $user['id_level_user']);?>
						</div>
					</td>
				</tr>
				<tr>
					...
					<td>
						<div class="col-sm-10">
							<?php echo cmb_dinamis('id_guru', 'tbl_guru', 'nama_guru', 'id_guru', $user['id_guru']);?>
						</div>
					</td>
				</tr>
				<tr>
						...
						<div class="col-sm-10">
							...
							<?php
								if(empty($user['foto'])){
									...
									echo "<img width='200' src='".base_url()."/uploads/foto_user/".$user['foto']."'>";
								}
							?>
						</div>
					</td>
