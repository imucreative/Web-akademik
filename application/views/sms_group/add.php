<div class="col-sm-12">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <i class="fa fa-external-link-square"></i>Form Input Daftar SMS Group
        ...
        <div class="panel-body">
            ...
            ?>
				<tr>
					...
					<td>
						<div class="col-sm-12">
							<input type="text" name="nama_group" placeholder="* Nama Group" id="form-field-1" class="form-control limited" maxlength='30' required />
						</div>
					</td>
				</tr>
				<tr>
					<td align='right'>
						<label class="col-sm-12 control-label" for="form-field-2">FILE EXCEL :</label>
					</td>
					<td>
						<div class="col-sm-10">
