<div class="col-sm-12">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <i class="fa fa-external-link-square"></i>Form Input Ruangan
        ...
        <div class="panel-body">
            ...
            ?>
				...
				<tr>
					...
					<td>
						<div class="col-sm-10">
							<input type="text" name="kd_ruangan" placeholder="* Kode Ruangan" id="form-field-1" class="form-control limited" maxlength='5' required />
						</div>
				...
				<tr>
					...
					<td>
						<div class="col-sm-12">
							<input type="text" name="nama_ruangan" placeholder="* Nama Ruangan" id="form-field-2" class="form-control" maxlength='100' required />
						</div>
					</td>
				</tr>
				<tr>
