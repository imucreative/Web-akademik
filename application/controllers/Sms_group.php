...
Class Sms_group extends CI_Controller {
        ...
        $columns = array(
            ...
            array(
                ...
                'formatter' => function( $d) {
                    ...
                    return anchor('sms_group/edit/' . $d, '<i class="fa fa-edit"></i>', "title='Edit' class='btn btn-xs btn-teal tooltips' data-placement='top' data-original-title='Edit'") . ' 
                        ' . anchor('sms_group/delete/' . $d, '<i class="fa fa-trash-o"></i>', "class='btn btn-xs btn-danger tooltips' data-placement='top' data-original-title='Delete' onclick='return confirm(Are you sure?)'");
                }
            )
        );
    ...
    function index() {
		$data['sms_group']	= $this->Model_sms_group->daftar_sms_group();
        $this->template->load('template', 'sms_group/list', $data);
    }
