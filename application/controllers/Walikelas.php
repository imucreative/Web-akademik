    ...
    function data() {
        ...
        $columns = array(
            ...
            array('db' => 'id_walikelas', 
				...
				return cmb_dinamis('guru', 'tbl_user', 'nama_lengkap', 'id_guru', $walikelas['id_guru'], "id='guru$d' onchange='updateDataWalikelas($d)'");
			}),
        );
        ...
        $where = "id_tahun_akademik='".get_tahun_akademik_aktif('id_tahun_akademik')."'";
        echo json_encode(
